var datos2 = document.getElementById('main-header')
...
<div class="navbar">
  ...
  <ul class="nav2">
    <a class="svbtn bb Darkons currentPlace" href="DarkonS.html"><img class="AA" src="IMG/face.png" alt=""> DarkonS</a>
  </ul>
